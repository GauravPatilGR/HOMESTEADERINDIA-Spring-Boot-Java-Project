...
<body>
    ...
    <div class="content">
        <h3> Training Request by Agro Students <i class="fas fa-graduation-cap"></i></h3>
        <div>
            <form id="searchForm" action="#" method="get">
    
    <input type="text" id="districtSearchs" name="district" onkeyup="search()" placeholder="Search By Nearby District " style="width:300px; border-radius:34px;"><i class="fa-solid fa-magnifying-glass"></i>&nbsp;&nbsp;&nbsp;&nbsp;
